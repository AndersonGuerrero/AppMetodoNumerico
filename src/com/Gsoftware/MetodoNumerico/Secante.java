...
protected void onCreate(Bundle savedInstanceState)
{
		...
		setContentView(R.layout.activity_secante);
		 e=new Evaluador(); 
			this.txtX0=(EditText) findViewById(R.id.ValorX0Secante);
			this.txtX1=(EditText) findViewById(R.id.ValorX1Secante);
			this.txtError=(EditText) findViewById(R.id.ValorEsecante);
			this.txtFuncion=(EditText) findViewById(R.id.valorFSecante);
			this.txtresp=(TextView) findViewById(R.id.resultadosecante);
}
